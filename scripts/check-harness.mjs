...
expect(requirementsBaseline.expectedRuntime?.adminRouteCount === 25, "Executable requirements must lock the 25-route consumer subset");
...
expect(packageJson.version === "0.0.1-experimental.4", "release version must remain explicit");
